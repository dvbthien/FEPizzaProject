...
const Banner = () => {
    return (
        <section className="h-screen w-full relative z-[1]">
            ...
            <ul className="absolute bottom-[1.90337vw] left-[2.92826vw] font-bold font-century-condensed leading-none">
                <li className="list-country-banner"><a href="" className="text-[4.68521vw]">Vietnam</a></li>
                <li className="list-country-banner"><a href="" className="text-[4.68521vw]">Cambodia</a></li>
                <li className="list-country-banner"><a href="" className="text-[4.68521vw]">India <span className="text-[1.46413vw]">coming soon</span></a></li>
                <li className="list-country-banner"><a href="" className="text-[4.68521vw]">Japan <span className="text-[1.46413vw]">coming soon</span></a></li>
            </ul>
