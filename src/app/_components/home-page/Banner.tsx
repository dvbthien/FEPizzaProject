    ...
    return (
        <section className="h-screen w-full relative z-[1]">
            ...
            <ul className="absolute bottom-[1.90337vw] left-[2.92826vw] font-normal leading-none">
                <li className="listCountryBanner"><a href="" className="text-[4.68521vw]">Vietnam</a></li>
                <li className="listCountryBanner"><a href="" className="text-[4.68521vw]">Cambodia</a></li>
                <li className="listCountryBanner"><a href="" className="text-[4.68521vw]">India <span className="text-[1.46413vw]">coming soon</span></a></li>
                <li className="listCountryBanner"><a href="" className="text-[4.68521vw]">Japan <span className="text-[1.46413vw]">coming soon</span></a></li>
            </ul>
            <div className="absolute group bottom-[30px] right-[2.19619vw] p-[0.58565vw] text-white hover:bg-[#02499D]">
                ...
                <div className="flex justify-end tracking-normal text-[2.56223vw] gap-[0.07321vw] h-[3.10146vw]">
                    <span className="text-[2.56223vw] pt-[0.21962vw] px-[0.21962vw] bg-black group-hover:bg-[#7daeeb]">1</span>
                    <span className="text-[2.56223vw] pt-[0.21962vw] px-[0.21962vw] bg-black group-hover:bg-[#7daeeb]">3</span>
                    <span className="text-[2.56223vw] pt-[0.21962vw] px-[0.21962vw] bg-black group-hover:bg-[#7daeeb]">5</span>,
                    <span className="text-[2.56223vw] pt-[0.21962vw] px-[0.21962vw] bg-black group-hover:bg-[#7daeeb]">7</span>
                    <span className="text-[2.56223vw] pt-[0.21962vw] px-[0.21962vw] bg-black group-hover:bg-[#7daeeb]">9</span>
                    <span className="text-[2.56223vw] pt-[0.21962vw] px-[0.21962vw] bg-black group-hover:bg-[#7daeeb]">0</span>
